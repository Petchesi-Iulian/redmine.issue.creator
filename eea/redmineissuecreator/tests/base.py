...
def setup_product():
    ...
    import eea.redmineissuecreator
    zcml.load_config('configure.zcml', eea.redmineissuecreator)
    ...
    ztc.installPackage('eea.redmineissuecreator')
...
setup_product()
ptc.setupPloneSite(products=['eea.redmineissuecreator'])
